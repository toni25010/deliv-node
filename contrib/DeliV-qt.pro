...
RESOURCES += src/qt/DeliV.qrc src/qt/DeliV_locale.qrc

TRANSLATIONS += src/qt/locale/DeliV_bg.ts \
                src/qt/locale/DeliV_de.ts \
                src/qt/locale/DeliV_en.ts \
                src/qt/locale/DeliV_es.ts \
                src/qt/locale/DeliV_fi.ts \
                src/qt/locale/DeliV_fr.ts \
                src/qt/locale/DeliV_it.ts \
                src/qt/locale/DeliV_ja.ts \
                src/qt/locale/DeliV_pl.ts \
                src/qt/locale/DeliV_pt.ts \
                src/qt/locale/DeliV_ru.ts \
                src/qt/locale/DeliV_sk.ts \
                src/qt/locale/DeliV_sv.ts \
                src/qt/locale/DeliV_vi.ts \
                src/qt/locale/DeliV_zh_CN.ts \
                src/qt/locale/DeliV_zh_TW.ts
