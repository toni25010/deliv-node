Contributing to DeliV Core
============================

The DeliV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DeliV Core project, and is not to be
confused with overall DeliV Network Protocol consensus changes.

Whether a pull request is merged into DeliV Core rests with the project merge
...
Patches that change DeliV consensus rules are considerably more involved than
...
Where a patch set proposes to change the DeliV consensus, it must have been
...
The project leader is the release manager for each DeliV Core release.
