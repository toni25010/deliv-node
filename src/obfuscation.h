...
{
public:
    /// Is the inputs associated with this public key? (and there is 2000 DELIV - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of DeliV.
