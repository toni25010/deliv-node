/* src/config/DeliV-config.h.  Generated from DeliV-config.h.in by configure.  */
/* src/config/DeliV-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DELIV_CONFIG_H

#define DELIV_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.deliziaproject.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DeliV Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DeliV Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "DeliV"
