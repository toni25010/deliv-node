...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DeliV features */
        {"DeliV", "masternode", &masternode, true, true, false},
        {"DeliV", "listmasternodes", &listmasternodes, true, true, false},
        {"DeliV", "getmasternodecount", &getmasternodecount, true, true, false},
        {"DeliV", "masternodeconnect", &masternodeconnect, true, true, false},
        {"DeliV", "masternodecurrent", &masternodecurrent, true, true, false},
        {"DeliV", "masternodedebug", &masternodedebug, true, true, false},
        {"DeliV", "startmasternode", &startmasternode, true, true, false},
        {"DeliV", "createmasternodekey", &createmasternodekey, true, true, false},
        {"DeliV", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"DeliV", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"DeliV", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"DeliV", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"DeliV", "getmasternodescores", &getmasternodescores, true, true, false},
        {"DeliV", "mnbudget", &mnbudget, true, true, false},
        {"DeliV", "preparebudget", &preparebudget, true, true, false},
        {"DeliV", "submitbudget", &submitbudget, true, true, false},
        {"DeliV", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"DeliV", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"DeliV", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"DeliV", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"DeliV", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"DeliV", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"DeliV", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"DeliV", "checkbudgets", &checkbudgets, true, true, false},
        {"DeliV", "mnsync", &mnsync, true, true, false},
        {"DeliV", "spork", &spork, true, true, false},
        {"DeliV", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"DeliV", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use DeliVd, or the -server option to DeliV-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> DeliV-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19200/\n";
}
