...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DeliV Core DeliV-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  DeliV-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded DeliV transaction") + "\n" +
                               "  DeliV-tx [options] -create [commands]   " + _("Create hex-encoded DeliV transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded DeliV transaction
