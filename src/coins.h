...
/** 
    ...
    ****Note - for DeliV we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of DeliV coming in to a transaction
