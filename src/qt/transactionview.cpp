                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DeliV from zDeliV"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDeliV"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDeliV));
