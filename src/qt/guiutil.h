...
/** Utility functions used by the DeliV Qt UI.
 */
namespace GUIUtil
{
...
// Render DeliV addresses in moDeliVpace font
...
// Parse "DeliV:" URI into recipient object, return true on successful parsing
