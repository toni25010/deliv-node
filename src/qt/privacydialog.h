...
public:
    ...
    void setZDeliVControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDELIV_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDELIV_clicked();
    void on_pushButtonZDeliVControl_clicked();
