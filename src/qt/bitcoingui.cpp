                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DeliV Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DeliV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and DeliV: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDELIV"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DeliV Core"), this);
    aboutAction->setStatusTip(tr("Show information about DeliV Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DeliV"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DeliV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DeliV addresses"));
    ...
    openAction->setStatusTip(tr("Open a DeliV: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DeliV Core help message to get a list with possible DeliV command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DeliV Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DeliV network", "", count));
}
...
{
    QString strTitle = tr("DeliV Core"); // default title
...
/** Creates context menu, its actions, and DeliVs up all the relevant signals for mouse events. */
