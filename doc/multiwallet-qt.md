...
In order to support loading of multiple wallets in DeliV-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is DeliV.cpp.
...
Changes to DeliV.cpp
----------------------
DeliV.cpp is the entry point into DeliV-qt, and as such, will require some minor modifications to provide hooks for
